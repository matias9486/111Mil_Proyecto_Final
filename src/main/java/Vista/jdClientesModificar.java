 ...
 * @author Hatake
 */
public class jdClientesModificar extends javax.swing.JDialog {
    ...
    private List<Telefono> listaTelefonos; //probando para el modificar
...
//MIS METODOS
    ...
    public jdClientesModificar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public jdClientesModificar(javax.swing.JDialog parent, boolean modal, int idCliente) {
        super(parent, modal);
        initComponents();
        ...
        {       
            ...
            listaTelefonos=clienteModificar.getTelefonos();
            cargarTelefonos(listaTelefonos);
    ...
    private void jbtnModificarTelefonoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnModificarTelefonoActionPerformed
        ...
        try
        {
            ...
            if(continuar)
            {
                ...
                JOptionPane.showMessageDialog(null, "telefono."+ oTelefono.toString(), "indice", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(null, "indice."+ IdTelefonoLista, "indice", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(null, "telefonos."+ listaTelefonos.toString(), "Información", JOptionPane.INFORMATION_MESSAGE);
                
                /* funciona
                listaTelefonos.remove(IdTelefonoLista);                
                listaTelefonos.add(oTelefono);
                */
                                
                listaTelefonos.set(IdTelefonoLista, oTelefono); //funciona
            ...
            if(!listaTelefonos.isEmpty())
            {
                ...
                if ((fila > -1) && (columna > -1))
                {
                    if(columna==3) //modificar
                    {
                        ...
                        //IdTelefonoLista= listaTelefonos.indexOf(oTelefono);
                        IdTelefonoLista= fila;
                    }
                    if(columna==4) //eliminar
                    {
                        //if(telefonos.remove(oTelefono))
                        if(listaTelefonos.remove(oTelefono))
                        {
    ...
    private void jbtnAgregarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnAgregarClienteActionPerformed
        ...
        try
        {
            ...
            if(continuar)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "No se agregó el cliente.", "Advertencia", JOptionPane.WARNING_MESSAGE);
                }
            }
            else
            {
        ...
        try
        {
            ...
            if(continuar)
            {
               ...
               JOptionPane.showMessageDialog(null, "telefonos."+ listaTelefonos.toString(), "Información", JOptionPane.INFORMATION_MESSAGE);
                ...
                if(clientes.ModificarCliente(nro, nombre, apellido, direccion, activo, listaTelefonos))
                {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdClientesModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdClientesModificar dialog = new jdClientesModificar(new javax.swing.JFrame(), true);
